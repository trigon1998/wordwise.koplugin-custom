...
assert(diagnostics:find("Plugin version: 2026.07.1-rc1.4.11", 1, true),
    "diagnostics must expose the RC1.4.11 plugin version")
...
print("RC1.4.11 main behavior tests: PASS")
