...
assert_equal(metadata.version, "2026.07.1-rc1.3.1",
...
assert_equal(Updater.compareVersions(
    "2026.07.1-rc1.3.1", "2026.07.1-rc1.2.2"), 1,
...
local data_zip_name, data_checksum_name = Updater.dataAssetNamesForVersion("2026.07.1-rc1.3.1")
assert_equal(data_zip_name, "WordWise_Databases_2026.07.1-rc1.3.1.zip",
...
local zip_name, checksum_name = Updater.assetNamesForVersion("2026.07.1-rc1.3.1")
assert_equal(zip_name, "wordwise.koplugin-v2026.07.1-rc1.3.1.zip",
...
assert_equal(
    Updater.selectRelease(releases, "2026.07.1-rc1.3.1", true).tag_name,
    "v2026.07.1-rc1.4.0",
    "RC channel must select the newest eligible non-draft release")
assert_equal(
    Updater.selectRelease(releases, "2026.07.1-rc1.3.1", false),
    nil,
...
assert_equal(
    Updater.selectRelease(mixed_releases, "2026.07.1-rc1.3.1", false).tag_name,
    "v2026.07.1",
...
assert_equal(
    ...
    "v2026.07.1-rc1.3.1",
    "RC1.2.2 must discover the RC1.3.1 battery release")
assert_equal(
    Updater.selectRelease(battery_release, "2026.07.1-rc1.3.1", true),
    nil,
    "RC1.3.1 must not offer itself as an update")

print("RC1.3.1 updater logic tests: PASS")
