...
assert_equal(metadata.version, "2026.07.1-rc1.4.3",
...
assert_equal(Updater.compareVersions(
    "2026.07.1-rc1.4.3", "2026.07.1-rc1.4.1"), 1,
    "RC1.4.3 patch build must be newer than the RC1.4.1 baseline")
assert_equal(Updater.compareVersions(
...
local data_zip_name, data_checksum_name = Updater.dataAssetNamesForVersion("2026.07.1-rc1.4.3")
assert_equal(data_zip_name, "WordWise_Databases_2026.07.1-rc1.4.3.zip",
...
local zip_name, checksum_name = Updater.assetNamesForVersion("2026.07.1-rc1.4.3")
assert_equal(zip_name, "wordwise.koplugin-v2026.07.1-rc1.4.3.zip",
...
assert_equal(
    Updater.selectRelease(releases, "2026.07.1-rc1.4.3", true).tag_name,
    "v2026.07.1-rc1.4.4",
    "RC channel must select the newest eligible non-draft release")
assert_equal(
    Updater.selectRelease(releases, "2026.07.1-rc1.4.3", false),
    nil,
...
assert_equal(
    Updater.selectRelease(mixed_releases, "2026.07.1-rc1.4.3", false).tag_name,
    "v2026.07.1",
...
assert_equal(
    ...
    "v2026.07.1-rc1.4.3",
    "RC1.4.1 must discover the RC1.4.3 patch release")
assert_equal(
    Updater.selectRelease(battery_release, "2026.07.1-rc1.4.3", true),
    nil,
    "RC1.4.3 must not offer itself as an update")

print("RC1.4.3 updater logic tests: PASS")
