...
assert_equal(metadata.version, "2026.07.1-rc1.3.4",
...
assert_equal(Updater.compareVersions(
    "2026.07.1-rc1.3.4", "2026.07.1-rc1.2.2"), 1,
...
local data_zip_name, data_checksum_name = Updater.dataAssetNamesForVersion("2026.07.1-rc1.3.4")
assert_equal(data_zip_name, "WordWise_Databases_2026.07.1-rc1.3.4.zip",
...
local zip_name, checksum_name = Updater.assetNamesForVersion("2026.07.1-rc1.3.4")
assert_equal(zip_name, "wordwise.koplugin-v2026.07.1-rc1.3.4.zip",
    "release ZIP name must be deterministic")
assert_equal(checksum_name, zip_name .. ".sha256",
    "checksum asset must follow the ZIP name")

local releases = {
    { tag_name = "v2026.07.1-rc1.3.4", prerelease = true, draft = false },
...
assert_equal(
    Updater.selectRelease(releases, "2026.07.1-rc1.3.4", true).tag_name,
    "v2026.07.1-rc1.4.0",
    "RC channel must select the newest eligible non-draft release")
assert_equal(
    Updater.selectRelease(releases, "2026.07.1-rc1.3.4", false),
    nil,
...
assert_equal(
    Updater.selectRelease(mixed_releases, "2026.07.1-rc1.3.4", false).tag_name,
    "v2026.07.1",
...
assert_equal(
    ...
    "v2026.07.1-rc1.3.4",
    "RC1.2.2 must discover the RC1.3.4 battery release")
assert_equal(
    Updater.selectRelease(battery_release, "2026.07.1-rc1.3.4", true),
    nil,
    "RC1.3.4 must not offer itself as an update")

print("RC1.3.4 updater logic tests: PASS")
