...
Nguồn Wiktionary được ghi per-term trong override TSV và attribution/share-alike notice được đóng gói trong database bundle. Candidate vẫn cần được kiểm tra thực tế trước khi thay thế release công khai.
