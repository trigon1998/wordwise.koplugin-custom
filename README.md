...
**Phiên bản candidate hiện tại:** `2026.07.1-rc1.4.2`
...
theo cột văn bản và kiểm tra va chạm giữa các hint. Database schema v3 thêm cột context cho sense2; runtime vẫn tự động fallback để đọc schema v2 của các database cũ. Bản Full OTA RC1.4.2 sẽ cập nhật plugin cùng ba database để version và metadata luôn khớp, đồng thời không đụng tới `known_words.db`, sidecar hay tiến độ đọc.
...
RC1.4.2 chủ động dùng khoảng cách dòng tự động 180% để dành đủ vùng hiển thị
